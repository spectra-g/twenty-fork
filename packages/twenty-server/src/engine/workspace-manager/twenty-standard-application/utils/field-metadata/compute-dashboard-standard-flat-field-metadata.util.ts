...
>): Record<AllStandardObjectFieldName<'dashboard'>, FlatFieldMetadata> =>
  ({
    ...
    recordFilters: createStandardFieldFlatMetadata({
      objectName,
      workspaceId,
      context: {
        fieldName: 'recordFilters' as never,
        type: FieldMetadataType.RAW_JSON,
        label: 'Record Filters',
        description: 'Persisted dashboard-level record filters',
        icon: 'IconFilter',
        isNullable: true,
        isUIReadOnly: true,
      },
    ...
    recordFilterGroups: createStandardFieldFlatMetadata({
      objectName,
      workspaceId,
      context: {
        fieldName: 'recordFilterGroups' as never,
        type: FieldMetadataType.RAW_JSON,
        label: 'Record Filter Groups',
        description: 'Persisted dashboard-level record filter groups',
        icon: 'IconHierarchy',
        isNullable: true,
        isUIReadOnly: true,
      },
  ...
  }) as Record<AllStandardObjectFieldName<'dashboard'>, FlatFieldMetadata>;
