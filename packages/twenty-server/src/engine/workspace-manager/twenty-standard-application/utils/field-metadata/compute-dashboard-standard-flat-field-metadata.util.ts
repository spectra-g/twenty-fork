...
>): Record<AllStandardObjectFieldName<'dashboard'>, FlatFieldMetadata> => ({
  ...
  filterBarEnabled: createStandardFieldFlatMetadata({
    objectName,
    workspaceId,
    context: {
      fieldName: 'filterBarEnabled',
      type: FieldMetadataType.BOOLEAN,
      label: 'Filter Bar Enabled',
      description: 'Whether the dashboard filter bar is enabled',
      icon: 'IconFilter',
      isNullable: false,
      defaultValue: false,
    },
  ...
  filterConfiguration: createStandardFieldFlatMetadata({
    objectName,
    workspaceId,
    context: {
      ...
      description: 'Persisted dashboard filter configuration',
