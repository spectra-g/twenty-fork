...
export type UpdatePageLayoutWithTabsInput = {
  name: Scalars['String'];
  objectMetadataId?: InputMaybe<Scalars['UUID']>;
  recordFilterGroups?: InputMaybe<Scalars['JSON']>;
  recordFilters?: InputMaybe<Scalars['JSON']>;
